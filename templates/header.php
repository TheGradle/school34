  ...
  <div class="wrap">
    <nav class="header">
      ...
      <ul class="header-list">
        ...
        <li class="header-list__item"><a class="header-list__link <?=activeLink($link_documents, $current_url)?>" href="/documents.php">Документи</a></li>
...
<div class="header-mobile">
  <ul class="header-mobile-list">
    ...
    <li class="header-mobile-list__item"><a class="header-mobile-list__link" href="/information/reports/index.php">Звіти</a></li>
    <li class="header-mobile-list__item"><a class="header-mobile-list__link" href="/information/zno/index.php">ЗНО</a></li>
    <li class="header-mobile-list__item"><a class="header-mobile-list__link" href="/documents.php">Документи</a></li>
