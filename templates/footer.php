<div class="wrap">
  ...
  <div class="footer-links">
    ...
    <ul class="footer-links-list">
      <li class="footer-links-list__item"><a href="<?=$site_url ?>/index.php">Головна</a></li>
      <li class="footer-links-list__item"><a href="<?=$site_url ?>/about.php">Про нас</a></li>
      <li class="footer-links-list__item"><a href="<?=$site_url ?>/news/index.php">Новини</a></li>
      <li class="footer-links-list__item"><a href="<?=$site_url ?>/documents.php">Документи</a></li>
      <li class="footer-links-list__item"><a href="<?=$site_url ?>/gallery.php">Галерея</a></li>
    </ul>
  </div>
