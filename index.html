...
<body>
  <div class="page-main">
    ...
    <div class="slider">
      <div class="slider-item">
        ...
        <img src="img/slider.jpg" alt="" class="slider-item__img">
      </div>
      <div class="slider-item">
        <h2>Test 2</h2>
        <img src="https://mobile.photoprocenter.ru/files/201503021621525967_0.jpg" alt="" class="slider-item__img">
      </div>
      <div class="slider-item">
        <h2>Test 3</h2>
        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAOEAAADhCAMAAAAJbSJIAAAAA1BMVEUAAP+KeNJXAAAASElEQVR4nO3BgQAAAADDoPlTX+AIVQEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADwDcaiAAFXD1ujAAAAAElFTkSuQmCC" alt="" class="slider-item__img">
      </div>
    </div>
  </div>
  <div class="page">
    ...
    <div class="wrap">
      ...
      <div class="about">
        <div class="about-text">
          <p class="about-text__name">- Лесіна Тетяна Анатоліївна</p>
  ...
  <div class="page">
    <h2 class="wrap page__title">Контакти</h2>
    <div class="contacts">
