  ...
  <header>
        ...
        <ul class="header-list">
          ...
          <li class="header-list__item header-list-dropdown">
            ...
            <ul class="header-list-dropdown-list">
              <li class="header-list-dropdown-list__item"><a href="../reports/index.php">Звіти</a></li>
              <li class="header-list-dropdown-list__item header-list__item_active"><a href="index.php">ЗНО</a></li>
            </ul>
          </li>
    ...
    <ul class="header-list_mobile">
      ...
      <li class="header-list__item header-list-dropdown">
        ...
        <ul class="header-list-dropdown-list">
          <li class="header-list-dropdown-list__item"><a href="../reports/index.php">Звіти</a></li>
          <li class="header-list-dropdown-list__item"><a href="index.php">ЗНО</a></li>
        </ul>
      </li>
      <li class="header-list__item"><a href="../../documents.php">Документи</a></li>
      <li class="header-list__item"><a href="../../gallery.php">Галерея</a></li>
